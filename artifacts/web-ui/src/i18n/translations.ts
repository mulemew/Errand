export interface Translations {
  ...
  export const zh: Translations = {
    ...
    pageNotFoundHint: "该页面不存在或已被移除。",
      ...
      sourceBrowserforge: "browserforge 合成（推荐，已约束到主流分辨率）",
      sourceRealPreset: "真机预设（camoufox 自带，数量很少会重复）",
  ...
  export const en: Translations = {
    ...
    pageNotFoundHint: "Did you forget to add the page to the router?",
      ...
      sourceBrowserforge: "browserforge (synthetic, constrained to mainstream screens)",
      sourceRealPreset: "Real device preset (only a handful ship with camoufox, so they repeat)",
      generateHint:
