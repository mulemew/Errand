export interface Translations {
  ...
  export const zh: Translations = {
    ...
    pageNotFoundHint: "该页面不存在或已被移除。",
      ...
      startingUrlHint: "这是它现在停留的位置，不动就继续从这里恢复；改成别的网址，以后每次都从新网址打开。",
  ...
  export const en: Translations = {
    ...
    pageNotFoundHint: "Did you forget to add the page to the router?",
      ...
      startingUrlHint: "Where it is now — leave it and it keeps resuming here. Change it and it opens at the new address every time.",
