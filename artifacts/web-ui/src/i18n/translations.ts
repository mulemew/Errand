export interface Translations {
    ...
    pageNotFoundHint: string;
      ...
      backupPassphraseAgain: string;
      backupPassphraseMismatch: string;
      backupPassphraseTooShort: string;
      backupIncludeSessions: string;
      backupIncludeSessionsHint: string;
      ...
      backupImportedDetail: string;
      backupFailed: string;
      backupWarnLostPassphrase: string;
  ...
  export const zh: Translations = {
    ...
    pageNotFoundHint: "该页面不存在或已被移除。",
      ...
      backupTitle: "备份与还原",
      backupHint: "把整个实例导出成一个加密文件：任务、分组、指纹、代理、凭证、浏览器会话、Providers、设置。换一台机器只要这个文件和口令就能还原。",
      backupExportTitle: "导出备份",
      backupExportHint: "文件整体加密，服务器不留副本。口令只在这一次用到，我们不保存——丢了就永远打不开。",
      backupPassphrase: "备份口令",
      backupPassphraseAgain: "再输一遍",
      backupPassphraseMismatch: "两次输入不一致",
      backupPassphraseTooShort: "口令至少 8 位",
      backupIncludeSessions: "包含浏览器登录态",
      backupIncludeSessionsHint: "已保存的登录会话。体积较大，且 cookie 会过期；只想搬配置可以不勾。",
      backupExportButton: "导出备份",
      backupExporting: "正在导出…",
      backupExported: "备份已下载",
      backupImportTitle: "从备份还原",
      backupImportHint: "只新增，不覆盖也不删除任何已有数据。还原进来的任务是禁用的、浏览器不会自动启动，确认无误后再手动打开。",
      backupChooseFile: "选择备份文件",
      backupNoFile: "还没有选择文件",
      backupImportButton: "还原",
      backupImporting: "正在还原…",
      backupImported: "还原完成",
      backupImportedDetail: "任务 {tasks}·指纹 {fingerprints}·代理 {proxies}·凭证 {credentials}·浏览器 {sessions}",
      backupFailed: "操作失败",
      backupWarnLostPassphrase: "口令没有找回途径。请把它存在你信得过的地方。",
      ...
      startingUrlHint: "下次打开的位置。默认是它关闭时停留的页面，改了就从新的开。",
  ...
  export const en: Translations = {
    ...
    pageNotFoundHint: "Did you forget to add the page to the router?",
      ...
      backupHint: "Export the whole instance as one encrypted file: tasks, groups, fingerprints, proxies, credentials, browser sessions, providers, settings. On another machine that file and its passphrase are all a restore needs.",
      backupExportTitle: "Export a backup",
      backupExportHint: "The file is encrypted as a whole and no copy is kept on the server. The passphrase is used once and never stored — lose it and the file cannot be opened, by anyone.",
      backupPassphrase: "Passphrase",
      backupPassphraseAgain: "Type it again",
      backupPassphraseMismatch: "The two entries do not match",
      backupPassphraseTooShort: "At least 8 characters",
      backupIncludeSessions: "Include browser sessions",
      backupIncludeSessionsHint: "Saved logins. Larger, and cookies expire — leave it off to move configuration only.",
      ...
      backupImportHint: "Additive only: nothing existing is overwritten or deleted. Restored tasks arrive disabled and browsers do not autostart — turn them on once you have checked them.",
      backupChooseFile: "Choose a backup file",
      backupNoFile: "No file chosen",
      backupImportButton: "Restore",
      backupImporting: "Restoring…",
      backupImported: "Restore complete",
      backupImportedDetail: "{tasks} tasks · {fingerprints} fingerprints · {proxies} proxies · {credentials} credentials · {sessions} browsers",
      backupFailed: "That did not work",
      backupWarnLostPassphrase: "There is no way to recover this passphrase. Keep it somewhere you trust.",
      ...
      startingUrlHint: "Where it opens next. Defaults to the page it was on when it closed; change it to open somewhere else.",
